...
table(entityId)
ggplot(RUZAFA, aes(entityId, fill =factor(year(dateObserved)))) + geom_bar(position = "dodge") +theme(axis.text.x = element_text(angle = 90, hjust = 1))+labs(x="Calles",y = "dias", title="Dias de estudio por calle") + guides(fill = guide_legend(title = "Años"))
detach(RUZAFA)
