...
#Por ultimo representamos las calles que mas han molestado a los vecinos en los ultimos 3 años
MinMol =ggplot(MinMolNoVe, aes(Mes, MinRuido, color = Calles, size=MaxRuido)) + geom_point(shape = 8, size = 4,)+ ggtitle("Calles con mayor nivel de ruido de media por mes sin verano")+scale_y_continuous(limits = c(20,70),name = "Nivel de ruido") 
MinMol
