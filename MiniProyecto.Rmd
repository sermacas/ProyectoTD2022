...
Utilizando las funciones $max()$ y $min()$ vemos que los datos se han recogido desde 2020-09-17 hasta 2022-04-10.
...
```{r}
# gráfico fecha registro
ggplot(RUZAFA_TIDY, aes(x = Fecha_Registro, y = Valores)) +
  geom_line(aes(group_by = Fecha_Registro, col = Fecha_Registro))
```
```{r}
