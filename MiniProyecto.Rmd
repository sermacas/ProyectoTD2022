...
ggplot(datos_semana, aes(x = dia, y = Media, color = Calles)) + 
  ...
  scale_x_discrete(labels = c("lunes","martes","miercoles","jueves","viernes","sabado","domingo")) + scale_y_discrete(limits = c(0,100,50)) + geom_smooth()

#LAS LINEAS ES DONDE SE SITUAN LAS MEDIAS
```
