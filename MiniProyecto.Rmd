...
```{r}
ggplot(ruido_calle, aes(x = dia, y = valor, color = dia)) + 
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = 90)) +
...
Podemos ver que el día en el que la sonoridad llega a el nivel más alto es el domingo, pero en general, el día que tiene los niveles sonoros más altos es el sábado.
